...
# Threads (連投) publishing: a whole thread publishes in ONE run (parent →
# replies in seq order, replies reply_to the parent) and counts as one unit
# against MAX_POSTS_PER_RUN / MAX_POSTS_PER_DAY. This is the short gap between
# the parent and each reply within that run.
THREAD_REPLY_DELAY_SECONDS = 30
